...
$(document).ready(function(){
	...
	$(".range-title").html("<span style='font-size:18px;font-weight:normal;'>Em </span>0 mês");
	$(".info-price").html('Você economiza');
	$(".annual-price").html('R$ 0');
    
    new Dragdealer('pr-slider', {
    animationCallback: function(x, y) {
		// console.log(x);
      var slider_value = ((Math.round(x * 12)));
      //$("#pr-slider .value").text(slider_value);
      var stripe_width = slider_value * 8.33333333333333333333333333333333;
      $(".stripe").css("width", ""+stripe_width+"%");
	//   console.log(slider_value);
	  
	  if (slider_value > 1) {
		  	$(".range-title").html("<span style='font-size:18px;font-weight:normal;'>Em </span>"+slider_value+" meses")
		} else {
			$(".range-title").html("<span style='font-size:18px;font-weight:normal;'>Em </span>"+slider_value+" mês")	
		}
	  $(".info-price").html('Você economiza');
	  $(".annual-price").html('R$' + slider_value * 900);
      //set personal
